...
//            document.add(new Paragraph("Customer on Profile: " + oneCustomerIvoice.getProfileName()));
            ...
            Image image = Image.getInstance("C:"+File.separatorChar+"Users"+File.separatorChar+"amrws"+File.separatorChar+"Desktop" +File.separatorChar +"BillingModule"+File.separatorChar+"src" + File.separatorChar + "java" + File.separatorChar
                    + "img" + File.separatorChar + "logo-orange.png");
