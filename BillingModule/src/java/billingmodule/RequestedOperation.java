...
public class RequestedOperation {
    ...
    public void requestHandlingFromStartMethod (String request, BillDateInterval intervalBill) throws SQLException{
    ...
    public void requestHandlingFromWebService (String request, String msisdn, BillDateInterval intervalBill) throws SQLException{
        BillingModule module = new BillingModule();
        databaseConnection db = new databaseConnection();
        ...
        if(request.equals(CustomerNum.oneCustomer))
        {
            ...
            System.out.printf("Please,enter Customer's DialNum: ");
            String dialNum = msisdn;  // Read user input
            System.out.println("dialNum" + dialNum);
