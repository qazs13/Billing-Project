...
<%@page import="Database_Tables.Customer_Profile"%>
        ...
        <%
            ...
            int i,j,x;
                    ...
                    <div id="customer_data1">
                        ...
                        <p id="pfees"> Fees  :  <% out.println(profile.elementAt(x).getpFees());out.println("L.E"); %> </p>
                        <p id="renew"> Renew Duration  :  <% out.println(profile.elementAt(x).getRenew_Duration());out.println("days"); %> </p>                        
